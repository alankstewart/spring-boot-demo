...
create table Orders(id bigint auto_increment primary key, customer_id bigint, shippingaddress_id bigint, billingAddress_id bigint, created timestamp, version int);
