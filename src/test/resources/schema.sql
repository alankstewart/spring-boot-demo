...
create sequence customer_seq minvalue 1 start with 4;

drop sequence if exists address_seq;
create sequence address_seq minvalue 1 start with 3;

drop sequence if exists product_seq;
create sequence product_seq minvalue 1 start with 4;

drop sequence if exists orders_seq;
create sequence orders_seq minvalue 1 start with 2;

drop sequence if exists line_item_seq;
create sequence line_item_seq minvalue 1 start with 3;
